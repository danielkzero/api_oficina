...
class GetPedido
{
    ...
    public function __invoke(Request $request, Response $response, $args)
    {
        ...
        // Organize the data to combine multiple rows into a structured format
        $pedidosOrganizados = [];
        ...
        return $response->withHeader('Content-Type', 'application/json')->withJson(array_values($pedidosOrganizados));
    }
}
